...
urlpatterns = [
    ...
    path('meals/<int:pk>/update/', views.Meal_Update.as_view(), name='meal_update'),
    path('meals/<int:pk>/delete/', views.Meal_Delete.as_view(), name='remove_meal'),
    path('meals/calendar/', views.CalendarView.as_view(), name='meal_calendar'),
]